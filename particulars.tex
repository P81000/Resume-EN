...
\def\profile{Mid-Level Developer at AeroRiver \textbar\
             Computer Science       \textbar\
             Electronic Technician  \textbar\
             Embedded Systems, Software Developer, Computer Vision, Fullstack, CyberSecurity \textbar\
             C/C++, Bash, Rust, Python, Lua, Go, Vue3, Linux, Git, Docker}
...
\def\resume{
    ...
    as a Mid-Level Embedded Software Developer at AeroRiver, specializing in embedded systems programming applied to aeronautics.
    \\
    \\
    ...
    by the institution. In this role, I guided students in carrying out the Olympics tests, aiming to win medals. My main and most
    recent experience is as an embedded software developer at AeroRiver, where I primarily focus my work. I also work as a
    freelance system and software developer and as a programming instructor. In terms of my technical qualifications, I am proficient
    in programming with C/C++, Bash, Rust and Python, where I've applied my skills to solve a variety of real-world challenges. Additionally,
    I am well-versed in Linux systems, electronics and embedded systems, enabling me to work in versatile computing environments and roles.
}
...
{Present}
{AeroRiver}
{Embedded \& Aeronautic Systems Developer}
{São José dos Campos}
{
\jbegin
